...
/**
 * Tests for the user-friendly error message conversion in BotMessageProcessor.
...
class BotMessageProcessorErrorDisplayTest {
    ...
    void rateLimitError_returnsUserFriendlyMessage() {
        ...
        String result = BotMessageProcessor.toUserFriendlyError(error);
    ...
    void nullError_returnsGenericMessage() {
        String result = BotMessageProcessor.toUserFriendlyError(null);
        assertThat(result).isEqualTo("Temporary issue. Please try again.");
    }
