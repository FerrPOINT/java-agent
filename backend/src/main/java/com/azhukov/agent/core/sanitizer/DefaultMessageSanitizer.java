 ...
 * Mirrors the original project's agent/message_sanitization.py (_SURROGATE_RE).
 */
 ...
 * Mirrors the original project's _sanitize_surrogates and _sanitize_messages_surrogates.
 */
