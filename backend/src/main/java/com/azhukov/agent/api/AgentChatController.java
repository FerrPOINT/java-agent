...
public class AgentChatController {
    ...
    public Map<String, Object> refine(@Valid @RequestBody RefineRequest request) {
        ...
        var definitions = toolRegistry.getDefinitions(new HashSet<>(properties.getSkills().getDefaultToolsets()));
        boolean reviewSkills = definitions != null && definitions.stream()
